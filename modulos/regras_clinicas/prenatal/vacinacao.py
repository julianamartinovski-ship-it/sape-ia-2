...
REGRAS = [{'linha_cuidado': 'Pré-natal',
  ...
  'diagnostico': {'codigo': '10000837', 'termo': 'Falta de Conhecimento'},
  'resultado': {'codigo': '10027112', 'termo': 'Conhecimento, Adequado'},
  'intervencao': {'codigo': '10035217', 'termo': 'Avaliar Condição de Imunização'},
  'prioridade': 'Alta',
  ...
  'formulacao_clinica_original': {'diagnostico': 'Situação vacinal prejudicada',
                                  'resultado': 'Situação vacinal avaliada e atualizada',
                                  'intervencao': 'Avaliar situação vacinal da gestante'},
 ...
 {'linha_cuidado': 'Pré-natal',
  ...
  'diagnostico': {'codigo': '10030026', 'termo': 'Não Adesão ao Regime de Imunização'},
  'resultado': {'codigo': '10030185', 'termo': 'Adesão ao Regime de Imunização'},
  'intervencao': {'codigo': '10031559', 'termo': 'Implementar Regime de Imunização'},
  'prioridade': 'Alta',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Risco de imunização incompleta contra difteria e tétano',
                                  'resultado': 'Esquema vacinal contra difteria e tétano completado',
                                  'intervencao': 'Completar esquema vacinal com dT conforme histórico vacinal'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'diagnostico': {'codigo': '10030026', 'termo': 'Não Adesão ao Regime de Imunização'},
  'resultado': {'codigo': '10030185', 'termo': 'Adesão ao Regime de Imunização'},
  'intervencao': {'codigo': '10030429', 'termo': 'Administrar Vacina'},
  'prioridade': 'Alta',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Necessidade de imunização contra difteria, tétano e coqueluche',
                                  'resultado': 'Gestante imunizada com dTpa',
                                  'intervencao': 'Administrar ou encaminhar para vacina dTpa a partir da 20ª semana '
                                                 'gestacional'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Imunização materna ausente contra coqueluche',
                                  'resultado': 'Vacinação dTpa realizada no período oportuno',
                                  'intervencao': 'Realizar busca ativa para vacinação dTpa'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Necessidade de imunização contra influenza',
                                  'resultado': 'Gestante imunizada contra influenza',
                                  'intervencao': 'Administrar ou encaminhar para vacina influenza sazonal'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Imunização ausente contra influenza',
                                  'resultado': 'Vacinação contra influenza realizada',
                                  'intervencao': 'Orientar e encaminhar gestante para vacinação contra influenza'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Risco de imunização incompleta contra hepatite B',
                                  'resultado': 'Esquema vacinal contra hepatite B completado',
                                  'intervencao': 'Completar esquema vacinal contra hepatite B'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Imunização ausente contra hepatite B',
                                  'resultado': 'Esquema vacinal contra hepatite B iniciado',
                                  'intervencao': 'Iniciar vacinação contra hepatite B conforme calendário da gestante'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Necessidade de imunização contra COVID-19',
                                  'resultado': 'Gestante imunizada contra COVID-19',
                                  'intervencao': 'Encaminhar gestante para vacinação contra COVID-19'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'diagnostico': {'codigo': '10030026', 'termo': 'Não Adesão ao Regime de Imunização'},
  'resultado': {'codigo': '10030185', 'termo': 'Adesão ao Regime de Imunização'},
  'intervencao': {'codigo': '10024214', 'termo': 'Obter Dados sobre Barreiras para Adesão'},
  'prioridade': 'Alta',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Adesão prejudicada à vacinação',
                                  'resultado': 'Gestante orientada e decisão vacinal reavaliada',
                                  'intervencao': 'Realizar aconselhamento sobre vacinação na gestação'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  'achado_clinico': 'Medo de reação vacinal',
  'diagnostico': {'codigo': '10000703', 'termo': 'Medo'},
  'resultado': {'codigo': '10027889', 'termo': 'Medo, Reduzido'},
  'intervencao': {'codigo': '10026208', 'termo': 'Aconselhar sobre Medos'},
  'prioridade': 'Média',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Medo relacionado à vacinação',
                                  'resultado': 'Medo reduzido e vacinação aceita ou reavaliada',
                                  'intervencao': 'Orientar sobre eventos adversos esperados e sinais de alerta'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Acesso prejudicado à vacinação',
                                  'resultado': 'Acesso à vacinação garantido',
                                  'intervencao': 'Articular acesso da gestante à sala de vacina'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  'achado_clinico': 'Barreiras culturais relacionadas à vacinação',
  'diagnostico': {'codigo': '10022397', 'termo': 'Crença Cultural, Conflituosa'},
  'resultado': {'codigo': '10028731', 'termo': 'Tomada de Decisão, Eficaz'},
  'intervencao': {'codigo': '10046099', 'termo': 'Intermediação Cultural'},
  'prioridade': 'Média',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Conflito cultural relacionado à vacinação',
                                  'resultado': 'Barreiras culturais identificadas e manejadas',
                                  'intervencao': 'Realizar cuidado culturalmente congruente sobre vacinação'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Vulnerabilidade territorial para atraso vacinal',
                                  'resultado': 'Vacinação viabilizada conforme realidade territorial',
                                  'intervencao': 'Planejar vacinação conforme contexto ribeirinho'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'},
 {'linha_cuidado': 'Pré-natal',
  'categoria': 'Vacinação',
  ...
  'referencias': ['Ministério da Saúde. Calendário Nacional de Vacinação da Gestante, 2026.',
                  ...
                  'COFEN Resolução nº 736/2024.',
                  'Leininger M. Teoria da Diversidade e Universalidade do Cuidado Cultural.'],
  'formulacao_clinica_original': {'diagnostico': 'Registro vacinal ausente',
                                  'resultado': 'Registro vacinal recuperado ou atualizado',
                                  'intervencao': 'Solicitar, recuperar ou reconstruir registro vacinal'},
  'mapeamento_cipe': 'CIPE 2019 — termo oficial vinculado por revisão clínica'}]
